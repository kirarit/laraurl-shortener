...
class UrlController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $data['shortener_url'] = Str::lower(Str::random(5));
        Url::create($data);
    ...
    public function update(Request $request, Url $url)
    {
        ...
        $validated['shortener_url'] = Str::lower(Str::random(5));
    ...
    public function shortenLink($shortener_url)
    {
        ...
        // Use optional() to safely access properties
        return redirect(optional($find)->original_url);
    }
}
